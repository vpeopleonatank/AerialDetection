...
def parse_args():
    ...
    parser.add_argument('--det-pattern', type=str,
            default=r'labelTxt_remerged/Task1_{:s}.txt')
    parser.add_argument('--ann-path', help='Original annotation path', type=str,
            default=r'labelTxt/{:s}.txt')
    parser.add_argument('--image-txt', help='image path in txt file (filename without extension)', type=str,
            default=r'test.txt')
