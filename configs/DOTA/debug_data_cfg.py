...
data_root= '/mnt/Data/Project/ShipDetection/Data_Ship/DOTA_truncated_splitted_1024/trainval1024/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'Shipdata_trainval_full_1024_index0.json',
