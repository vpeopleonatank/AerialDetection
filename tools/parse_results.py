...
def parse_args():
    ...
    parser.add_argument('--pkl-path', default=r'work_dirs/results.pkl',
                        help='path to pickle result file')
    parser.add_argument('--out-path', default=r'work_dirs/output_path',
                        help='Output folder')
